...
class GeneralLedgerPage extends Page implements HasForms
{
                ...
                Section::make('Filters')
                    ->schema([
                        ...
                        \Filament\Forms\Components\Select::make('data_source')
                            ->label('Data Source')
                            ->options([
                                'all'            => '🔀 All (Vouchers, JEs, Purchases)',
                                'both'           => '🔀 Vouchers & JEs Only',
    ...
    public function ledgerGroups(): Collection
    {
        ...
        return app(\App\Services\GeneralLedgerService::class)
            ->getLedgerGroups($from, $to, $accountId, $branch, $basis, $payee, $dataSource);
    }
